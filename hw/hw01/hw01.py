...
def largest_factor(n):
    ...
    # Note: This method has unnecessarily long code
    # Can just start from factor = n - 1 and work your way down and it will be much faster


def largest_factor_correction(n):
    factor = n - 1
    while factor > 0:
        if n % factor == 0:
            return factor
